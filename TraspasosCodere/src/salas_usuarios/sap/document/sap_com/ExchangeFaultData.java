...
public class ExchangeFaultData  implements java.io.Serializable {
    ...
    private salas_usuarios.sap.document.sap_com.ExchangeLogData[] faultDetail;
    ...
    public ExchangeFaultData(
           ...
           salas_usuarios.sap.document.sap_com.ExchangeLogData[] faultDetail) {
     ...
     * @return faultDetail
     */
    public salas_usuarios.sap.document.sap_com.ExchangeLogData[] getFaultDetail() {
        return faultDetail;
    }
     ...
     * @param faultDetail
     */
    public void setFaultDetail(salas_usuarios.sap.document.sap_com.ExchangeLogData[] faultDetail) {
        this.faultDetail = faultDetail;
    }

    public salas_usuarios.sap.document.sap_com.ExchangeLogData getFaultDetail(int i) {
        return this.faultDetail[i];
    }

    public void setFaultDetail(int i, salas_usuarios.sap.document.sap_com.ExchangeLogData _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("unr:sap-com:document:sap:salas_usuarios", "ExchangeFaultData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("unr:sap-com:document:sap:salas_usuarios", "ExchangeLogData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
