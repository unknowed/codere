...
public class ExchangeFaultData  implements java.io.Serializable {
    ...
    private entrada_cendest.sap.document.sap_com.ExchangeLogData[] faultDetail;
    ...
    public ExchangeFaultData(
           ...
           entrada_cendest.sap.document.sap_com.ExchangeLogData[] faultDetail) {
     ...
     * @return faultDetail
     */
    public entrada_cendest.sap.document.sap_com.ExchangeLogData[] getFaultDetail() {
        return faultDetail;
    }
     ...
     * @param faultDetail
     */
    public void setFaultDetail(entrada_cendest.sap.document.sap_com.ExchangeLogData[] faultDetail) {
        this.faultDetail = faultDetail;
    }

    public entrada_cendest.sap.document.sap_com.ExchangeLogData getFaultDetail(int i) {
        return this.faultDetail[i];
    }

    public void setFaultDetail(int i, entrada_cendest.sap.document.sap_com.ExchangeLogData _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("unr:sap-com:document:sap:entrada_cendest", "ExchangeFaultData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("unr:sap-com:document:sap:entrada_cendest", "ExchangeLogData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
