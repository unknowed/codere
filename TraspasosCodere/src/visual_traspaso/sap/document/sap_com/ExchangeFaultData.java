...
public class ExchangeFaultData  implements java.io.Serializable {
    ...
    private visual_traspaso.sap.document.sap_com.ExchangeLogData[] faultDetail;
    ...
    public ExchangeFaultData(
           ...
           visual_traspaso.sap.document.sap_com.ExchangeLogData[] faultDetail) {
     ...
     * @return faultDetail
     */
    public visual_traspaso.sap.document.sap_com.ExchangeLogData[] getFaultDetail() {
        return faultDetail;
    }
     ...
     * @param faultDetail
     */
    public void setFaultDetail(visual_traspaso.sap.document.sap_com.ExchangeLogData[] faultDetail) {
        this.faultDetail = faultDetail;
    }

    public visual_traspaso.sap.document.sap_com.ExchangeLogData getFaultDetail(int i) {
        return this.faultDetail[i];
    }

    public void setFaultDetail(int i, visual_traspaso.sap.document.sap_com.ExchangeLogData _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("unr:sap-com:document:sap:visual_traspaso", "ExchangeFaultData"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("unr:sap-com:document:sap:visual_traspaso", "ExchangeLogData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
